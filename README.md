...
1. `admin-server`(`http://localhost:4000`)에 로그인 → 문제 제목, 난이도(상/중/하), 문제 유형(객관식/주관식), 문제 사진, (선택) 설명/해설을 입력해 등록
...
4. 문제 화면 상단에서 **확대/축소**로 사진을 크게 보고, **전체화면** 버튼으로 큰 화면(행사/발표용)에 꽉 채워서 볼 수 있음
5. 등록된 설명/해설이 있으면 "설명 / 해설 보기"로 확인 가능
